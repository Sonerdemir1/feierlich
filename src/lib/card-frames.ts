...
//
// links/rechts bewusst symmetrisch (jeweils der groessere der beiden
// gemessenen Werte) — die Kartenrahmen selbst sind links/rechts
// spiegelsymmetrisch, ein ungleicher Inset kam nur von einem einzelnen
// groesseren Blumenbuschel in einer Ecke und liess den Text optisch
// schief/nach links verschoben wirken (Kunden-Feedback).
export const CARD_TEXT_ZONE: Record<string, { top: number; right: number; bottom: number; left: number }> = {
  "dugun-01": { top: 22, right: 18, bottom: 18, left: 18 },
  "dugun-02": { top: 20, right: 21, bottom: 17, left: 21 },
  "dugun-04": { top: 22, right: 24, bottom: 21, left: 24 },
  "dugun-05": { top: 28, right: 23, bottom: 25, left: 23 },
  "dugun-06": { top: 20, right: 22, bottom: 18, left: 22 },
  "dugun-07": { top: 23, right: 28, bottom: 20, left: 28 },
  "dugun-08": { top: 22, right: 27, bottom: 19, left: 27 },
  "dugun-09": { top: 23, right: 25, bottom: 17, left: 25 },
  "dugun-11": { top: 22, right: 22, bottom: 13, left: 22 },
  "dugun-12": { top: 10, right: 16, bottom: 10, left: 16 },
  "dugun-14": { top: 12, right: 24, bottom: 18, left: 24 },
  "dugun-15": { top: 20, right: 31, bottom: 30, left: 31 },
};
